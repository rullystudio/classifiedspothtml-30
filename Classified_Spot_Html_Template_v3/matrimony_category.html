...
<title>Matrimony Category</title>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-3 col-sm-3 col-xs-12">
				<div id="logo">
					<a href="index.html"><img class="img-fluid logochange" src="images/logo.png" alt="logo" title="logo" /></a>
				</div>
			</div>
		...
		<div class="matter">
			<div class="pull-left">
				<ul class="list-inline">
					...
					<li><a href="matrimony_category.html">Matrimony Category</a></li>
				</ul>
			</div>
			<div class="pull-right">
				<h2>Matrimony Category</h2>
			</div>
		</div>
	</div>
</div>
				...
				<div class="row">
					<div class="product-layout product-grid col-lg-3 col-md-4 col-sm-6 col-xs-12 cols">
							<div class="product-thumb">
								<div class="image">
									<a href="ads_single_view.html"><img src="images/matrimony/01.jpg" alt="image" title="image" class="img-fluid"></a>
									<div class="onhover"> £3,000.00</div>
								</div>
								<div class="caption">
									...
									<ul class="list-unstyled">
										...
										<li><i class="la la-clock-o"></i> 09/03/2020</li>
									</ul>
